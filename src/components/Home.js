        ...
        <div className="jumbotron jumbotron-fluid bg-dark text-white home-jumbotron p-5" style={{ fontFamily: "MavenPro" }}>
            <div className="container">
                ...
                <a target="_blank" className="text-warning" href="https://api.nasa.gov/"><span> NASA's public API</span></a> to get all the data that I need.
                        ...
                        <LinkContainer className="text-warning" to="nasa-api-project/apod"><Link> APOD (Astronomy Picture of the Day)</Link>
                    </LinkContainer> or raw footages that are served by
                        <LinkContainer className="text-success" to="nasa-api-project/roverfootage/curiosity"><Link> Curiosity</Link></LinkContainer>
                        , <LinkContainer className="text-success" to="nasa-api-project/roverfootage/spirit"><Link> Spirit</Link></LinkContainer> and
                        <LinkContainer className="text-success" to="nasa-api-project/roverfootage/opportunity"><Link> Opportunity</Link></LinkContainer> (mars discovery rovers).
